                ...
                if actual_burst_completion_time > next_arrival_time:
                    ...
                    if next_arrivals[0].this_tau() < current_process.this_tau() or (next_arrivals[0].this_tau() == current_process.this_tau() and next_arrivals[0].pid < current_process.pid):
                        ...
                        if next_arrivals[0].burst_index == 0:
                            print("time {}ms: Process {} (tau {}ms) arrived; preempting {} {}".format( self.time, next_arrivals[0].pid, next_arrivals[0].this_tau(),current_process.pid, self.__printreadyqueue__(ready_q))) if self.time <= 9999 else None
                        else:
                            print("time {}ms: Process {} (tau {}ms) completed I/O; preempting {} {}".format( self.time, next_arrivals[0].pid, next_arrivals[0].this_tau(),current_process.pid, self.__printreadyqueue__(ready_q))) if self.time <= 9999 else None
                    ...
                    for i in range(preempted, len(next_arrivals)):
                        ...
                        heappush(ready_q, (p.this_tau(), p.pid, p))
                        if p.burst_index == 0:
                            print("time {}ms: Process {} (tau {}ms) arrived; added to ready queue {}".format( next_arrival_time, p.pid, p.this_tau(), self.__printreadyqueue__(ready_q))) if self.time <= 9999 else None
                        else:
                            print("time {}ms: Process {} (tau {}ms) completed I/O; added to ready queue {}".format( next_arrival_time, p.pid, p.this_tau(), self.__printreadyqueue__(ready_q))) if self.time <= 9999 else None
